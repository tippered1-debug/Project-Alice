...
enum class transaction_kind : uint8_t { transfer = 0, repayment = 1, interest = 2, other = 3, tax_payment, public_debt_issuance, public_debt_service, public_spending, purchase, payroll, freight };
