...
enum class authority_kind : uint8_t { administer, regulate, levy_tax, spend_public_funds, license, enforce, adjudicate, command_forces, appoint, dismiss, issue_currency, expropriate, other };
